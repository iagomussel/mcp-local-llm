...
const testRealisticTokens = () => {
  return new Promise((resolve, reject) => {
    ...
    const testText = 'This technical document presents a detailed analysis of the system requirements and proposes a comprehensive solution to optimize application performance.';
